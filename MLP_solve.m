function result = MLP_solve(data)

    mdl = fitrnet(data.Xtr_n, data.ytr, 'LayerSizes', [64 32], ...
        'Activations', 'relu', 'IterationLimit', 1000, ...
        'Lambda', 1e-4, 'ValidationFraction', 0.1);
    ...
    result = eval_tf(bp, data.sysH, data.t, data.yH, data.DC, 'MLP');
