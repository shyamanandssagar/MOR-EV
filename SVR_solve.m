function result = SVR_solve(data)

    mdl = fitrsvm(data.Xtr_n, data.ytr, 'KernelFunction','rbf', ...
        'BoxConstraint', 200, 'Epsilon', 0.5, 'KernelScale','auto');
    ...
    result = eval_tf(bp, data.sysH, data.t, data.yH, data.DC, 'SVR');
